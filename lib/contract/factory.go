...
var FactoryContractMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_questionName\",\"type\":\"string\"},{\"internalType\":\"string[]\",\"name\":\"_choices\",\"type\":\"string[]\"},{\"internalType\":\"uint256\",\"name\":\"_startBetAt\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_betDuration\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_startVoteAt\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_voteDuration\",\"type\":\"uint256\"}],\"name\":\"createQuestion\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getQuestionAddress\",\"outputs\":[{\"internalType\":\"address[]\",\"name\":\"\",\"type\":\"address[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"questionAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
// GetQuestionAddress is a free data retrieval call binding the contract method 0x6e5a1a31.
//
// Solidity: function getQuestionAddress() view returns(address[])
func (_FactoryContract *FactoryContractCaller) GetQuestionAddress(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _FactoryContract.contract.Call(opts, &out, "getQuestionAddress")
...
//
// Solidity: function getQuestionAddress() view returns(address[])
func (_FactoryContract *FactoryContractSession) GetQuestionAddress() ([]common.Address, error) {
	return _FactoryContract.Contract.GetQuestionAddress(&_FactoryContract.CallOpts)
}

// GetQuestionAddress is a free data retrieval call binding the contract method 0x6e5a1a31.
//
// Solidity: function getQuestionAddress() view returns(address[])
func (_FactoryContract *FactoryContractCallerSession) GetQuestionAddress() ([]common.Address, error) {
	return _FactoryContract.Contract.GetQuestionAddress(&_FactoryContract.CallOpts)
}

// QuestionAddress is a free data retrieval call binding the contract method 0x16e8af17.
//
// Solidity: function questionAddress(uint256 ) view returns(address)
func (_FactoryContract *FactoryContractCaller) QuestionAddress(opts *bind.CallOpts, arg0 *big.Int) (common.Address, error) {
	var out []interface{}
	err := _FactoryContract.contract.Call(opts, &out, "questionAddress", arg0)
...
//
// Solidity: function questionAddress(uint256 ) view returns(address)
func (_FactoryContract *FactoryContractSession) QuestionAddress(arg0 *big.Int) (common.Address, error) {
	return _FactoryContract.Contract.QuestionAddress(&_FactoryContract.CallOpts, arg0)
}

// QuestionAddress is a free data retrieval call binding the contract method 0x16e8af17.
//
// Solidity: function questionAddress(uint256 ) view returns(address)
func (_FactoryContract *FactoryContractCallerSession) QuestionAddress(arg0 *big.Int) (common.Address, error) {
	return _FactoryContract.Contract.QuestionAddress(&_FactoryContract.CallOpts, arg0)
}

// CreateQuestion is a paid mutator transaction binding the contract method 0x813c6ab0.
//
// Solidity: function createQuestion(string _questionName, string[] _choices, uint256 _startBetAt, uint256 _betDuration, uint256 _startVoteAt, uint256 _voteDuration) returns()
func (_FactoryContract *FactoryContractTransactor) CreateQuestion(opts *bind.TransactOpts, _questionName string, _choices []string, _startBetAt *big.Int, _betDuration *big.Int, _startVoteAt *big.Int, _voteDuration *big.Int) (*types.Transaction, error) {
	return _FactoryContract.contract.Transact(opts, "createQuestion", _questionName, _choices, _startBetAt, _betDuration, _startVoteAt, _voteDuration)
}

// CreateQuestion is a paid mutator transaction binding the contract method 0x813c6ab0.
//
// Solidity: function createQuestion(string _questionName, string[] _choices, uint256 _startBetAt, uint256 _betDuration, uint256 _startVoteAt, uint256 _voteDuration) returns()
func (_FactoryContract *FactoryContractSession) CreateQuestion(_questionName string, _choices []string, _startBetAt *big.Int, _betDuration *big.Int, _startVoteAt *big.Int, _voteDuration *big.Int) (*types.Transaction, error) {
	return _FactoryContract.Contract.CreateQuestion(&_FactoryContract.TransactOpts, _questionName, _choices, _startBetAt, _betDuration, _startVoteAt, _voteDuration)
}

// CreateQuestion is a paid mutator transaction binding the contract method 0x813c6ab0.
//
// Solidity: function createQuestion(string _questionName, string[] _choices, uint256 _startBetAt, uint256 _betDuration, uint256 _startVoteAt, uint256 _voteDuration) returns()
func (_FactoryContract *FactoryContractTransactorSession) CreateQuestion(_questionName string, _choices []string, _startBetAt *big.Int, _betDuration *big.Int, _startVoteAt *big.Int, _voteDuration *big.Int) (*types.Transaction, error) {
	return _FactoryContract.Contract.CreateQuestion(&_FactoryContract.TransactOpts, _questionName, _choices, _startBetAt, _betDuration, _startVoteAt, _voteDuration)
}
